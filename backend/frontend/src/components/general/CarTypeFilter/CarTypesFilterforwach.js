...
async function getCurrentParentId(CurrentCarFilterType, CurrentCarFilterId) {
  ...
  function init() {
    if( props.cartypesfilterobject.mkabaz != undefined || props.cartypesfilterobject.magad != undefined || props.cartypesfilterobject.magadal != undefined){
      loadMagadals();
    ...
    <div>
      ...
      <div>
                                      ...
                                      <Input onChange={(e) => {
                                        ...
                                        value={props.cartypesfilterobject.zadik} type="text" placeholder="צ'" disabled/>
                                    </div>
